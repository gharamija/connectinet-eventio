...
\end{packed_item}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.3]{slike/Opći_UC_dijagram_v2.0.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.5]{slike/Administrator_UC_dijagram.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.5]{slike/Korisnik_UC_dijagram.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.35]{slike/Organizator_UC_dijagram.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{slike/Posjetitelj_UC_dijagram.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
