\chapter{Specifikacija programske potpore}
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Sustav javlja korisniku da je novo korisničko ime ili e-mail zauzet
			\item Korisnik ponovno upisuje ime/e-mail ili odustaje od promjena te odabire opciju "Odustani"
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Sustav organizatora pita za potvrdu postavljanja događaja; organizator potvrđuje te sustav javlja organizatoru da je događaj uspješno objavljen
	\end{packed_enum}
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Organizator pri ispunjavanju podataka o događaju kojeg želi postaviti stavlja cijenu događaja veću od 0
		...
		\item Organizator ispunjava potrebne podatke te postavlja događaj odabirom opcije "DODAJ"
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Ako je izabrana ikona koša za smeće, sustav traži od organizatora potvrdu da želi izbrisati događaj te organizator potvrđuje odabirom opcije "Nastavi"
		\item Sustav javlja organizatoru da je uređivanje/brisanje uspješno te ga vraća na pregled događaja
	\end{packed_enum}
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Organizator potvrđuje željene promjene ili odustaje odabirom opcije "Odustani"
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Administrator ispod naznake "Cijena pretplate" ažurira cijenu članstva i odabire opciju "Spremi"
	...
	\item[] \begin{packed_item}
		...
		\item[1.a] Administrator postavio neispravnu cijenu
		\item[] \begin{packed_enum}
		...
		\end{packed_enum}
		\item[1.b] Administrator postavio ispravnu, ali pogrešnu cijenu ili želi odustati od promjene
		\item[] \begin{packed_enum}
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Administrator pronalazi željeni događaj te odabere opciju ikonu olovke ili ikonu koša za smeće
		...
		\item Ako je izabrana ikona koša za smeće, sustav traži od administratora potvrdu da želi izbrisati događaj te administrator potvrđuje odabirom opcije "Nastavi"
		\item Sustav javlja da je uređivanje/brisanje uspješno te vraća administratora na pregled događaja
	\end{packed_enum}
