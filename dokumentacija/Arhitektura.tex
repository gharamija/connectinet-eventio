	...
	Ovaj pristup omogućuje jasnu organizaciju sustava i olakšava daljnji razvoj i održavanje.
		...
		\end{itemize}
			...
			\subsection{Dijagram baze podataka}
					...
					\begin{figure}[H]
					\includegraphics[scale=0.7]{slike/baza.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
		...
		\section{Dijagram razreda}
			...
			\begin{figure}[H]
				\includegraphics[scale=0.55]{dijagramiKlasa/Dijagram razreda - Kontroleri.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.55]{dijagramiKlasa/Dijagram razreda - Servisi.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.43]{dijagramiKlasa/Dijagram razreda - DTO.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.42]{dijagramiKlasa/Dijagram razreda - Models v5.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\section{Dijagram stanja}
			...
			\begin{figure}[H]
			\includegraphics[scale=0.39]{dijagrami/DijagramStanja-Korisnik.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
